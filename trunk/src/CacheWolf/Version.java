...
public class Version {
	...
	static final String VER_SVN ="$LastChangedRevision: 1846 $"; // the number is automatically replaced by subversion to the latest versionnumer of this file (svn:keywords LastChangedRevision)
	...
	public static String getReleaseDetailed() {
		// habe die SVN-Nummer doch aus der Anzeige erstmal wieder herausgenommen, weil es in einem final Release doch recht seltsam aussďż˝he.
		// Sinnvoll wďż˝re daher vielleicht, eine Methode getReleaseDatail, die die SVN-Versionnummer mit angibt und z.B. im "ďż˝ber"-Dialog angezeigt werden kďż˝nnte.
