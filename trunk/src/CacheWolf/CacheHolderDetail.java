...
public class CacheHolderDetail {
	...
	/**
	 * change id in waypoint details and rename associated files. Function
	 * should only be called by CacheHolder
	 * 
	 * @param newWptId
	...
	protected boolean rename(String newWptId) {
		...
		try {
			...
			Global.getPref().log("Error renaming waypoint details", e,
