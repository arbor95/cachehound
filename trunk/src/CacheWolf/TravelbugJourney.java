...
public class TravelbugJourney {
	 ...
	 * virtual column is used to retrieve the AND of fromLogged and toLogged. It
	 * thus returns true only if bith transactions have been logged.
	 */
	public static final int BOTHLOGGED = 12;

	public TravelbugJourney(String id, String name, String trackingNo,
			String fromProfile, String fromWaypoint, String fromDate,
			String fromLogged, String toProfile, String toWaypoint,
			String toDate, String toLogged, String mission) {
	 ...
	 * 
	 * @param profile
	 *            The profile where the tb is dropped
	 * @param waypoint
	 *            the waypoint where the tb is dropped
	 */
	...
	public Object getElementByNumber(int elementNo) {
		...
		case 11:
			if (getToLogged())
				...
				return checkboxUnticked;
			/*
			 * Special case 12: Return Z if both moves have been logged, blank
			 * otherwise This allows the not logged tbJourneys to be sorted to
			 * the top.
			 */
		case 12:
	...
	/**
	 * Returns true if the travelbug is currently in my posession, i.e. it has a
	 * pick-up date but no drop date.
	 * 
	...
	private String getDateTime() {
		Time t = new Time();
		return MyLocale.formatLong(t.year, "0000") + "-"
				+ MyLocale.formatLong(t.month, "00") + "-"
				+ MyLocale.formatLong(t.day, "00") + " "
				+ MyLocale.formatLong(t.hour, "00") + ":"
				+ MyLocale.formatLong(t.minute, "00");
	}
