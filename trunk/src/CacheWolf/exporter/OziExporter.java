...
public class OziExporter extends Exporter {
	...
	public String record(CacheHolder ch, String lat, String lon) {
		...
		// be unique,
		// usually start at 1 and increment. Can be set to -1 (minus 1) and the
		// number will be auto generated.
		strBuf.append("-1,");
		// Field 2 : Name - the waypoint name, use the correct length name to
		// suit the GPS type.
		...
		strBuf.append(lon + ",");
		// Field 5 : Date - see Date Format below, if blank a preset date will
		// be used
		strBuf.append(",");
