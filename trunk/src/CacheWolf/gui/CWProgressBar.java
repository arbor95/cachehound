...
public class CWProgressBar {
	 ...
	 * 
	 * @param title
	 *            The string shown in the title of the progress bar
	 * @param pMinValue
	 *            The minimum of possible values
	 * @param pMaxValue
	...
	/**
	 * If set to yes the user is allowed to close the progress bar by clicking
	 * the closing x.
	 * 
	 * @param value
	 *            <code>true</code> if the user should be allowed to close the
	 *            progress bar by x.
	 */
