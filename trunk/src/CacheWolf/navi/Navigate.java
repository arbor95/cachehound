...
public class Navigate {
			...
			try {
				...
				(new MessageBox(
						...
						MyLocale
								...
								+ MyLocale
										.getMsg(4406,
												"Please copy jave_ewe.dll into the directory of the cachewolf program"),
						FormBase.OKB)).execute();
			}
		}
	}
	...
	public boolean isGpsPosValid() {
		return (serThread != null && serThread.isAlive() || gpsdThread != null
				&& gpsdThread.isAlive())
 ...
 * "ewe.sys.EventDirectionException: This task cannot be done within a Timer
 * Tick." in the ewe-vm when form.close is called.
 */
