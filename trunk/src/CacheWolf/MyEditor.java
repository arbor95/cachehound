...
public class MyEditor extends Editor {
	...
	/**
	 * Mainly overwritten of ewe.ui.Editor, except for the placement constraints
	 * for the buttons which allow for variable buttonConstraints.
	 */
		...
		if (buttons != null) {
			if (buttons.size() != 0) {
				if (Gui.isSmartPhone && getSoftKeyBarFor(null) == null) {
					...
					//
					// Here is difference from ewe.ui.Editor: CENTER ->
					// buttonConstraints
					//
