...
public enum CacheType {
	...
	/** custom waypoint */
	CUSTOM((byte) 0, "typeCustom.png", "Custom", "Custum", "C", false, false, "no Oc Id", "no GC Website ID"),
	/** traditional cache (GC,OC) */
	TRADITIONAL((byte) 2, "typeTradi.png", "Traditional", "Traditional Cache",
			"T", false, true, "2", "2"),
	/** multi cache (GC,OC) */
	MULTI((byte) 3, "typeMulti.png", "Multi", "Multi-cache", "M", false, true, "3", "3"),
	/** virtual cache (GC) */
	VIRTUAL((byte) 4, "typeVirtual.png", "Virtual", "Virtual Cache", "V", false, true, "4", "4"),
	/** letterbox cache (GC) */
	...
	/** moving cache (OC) */
	MOVING((byte) 9, "typeMoving.png", "Moving", "Unknown Cache", "U", false, true, "9", "no GC Website ID"),
	/** drive in cache (OC) */
	DRIVE_IN((byte) 10, "typeDrivein.png", "Drive in", "Traditional Cache", "T", false, true, "10", "no GC Website ID"),
	/** webcam cache (GC,OC) */
	WEBCAM((byte) 11, "typeWebcam.png", "Webcam", "Webcam Cache", "W", false, true, "5", "11"),
	...
	/** WhereIGo Cache (GC) */
	WHEREIGO((byte) 101, "typeWhereigo.png", "WhereIGo", "Wherigo Cache", "G", false, true, "no Oc Id", "1858"),
	/** Project Ape cache (GC) */
	APE((byte) 102, "typeApe.png", "Project Ape", "Project APE Cache", "T", false, true, "no Oc Id", "9"),
	...
	private CacheType(byte oldCWByte, String guiImage, String guiString,
			String gcGpxString, String shortExportString, boolean additionalWaypoint, boolean cacheWaypoint, String ocId, String gcWebsiteId) {
