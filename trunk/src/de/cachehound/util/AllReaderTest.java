...
public class AllReaderTest {
	private static class FakeReader extends Reader {
		...
		public int read(char[] cbuf) throws IOException {
			if (chunksread < chunks.length) {
				System.arraycopy(chunks[chunksread], 0, cbuf, 0,
						chunks[chunksread].length);
	...
	public void testReadAll() throws IOException {
		Reader fr = new FakeReader(new char[] { 'a', 'b' }, new char[] { 'c',
				'd' });
	...
	@Test
	public void testReadAllMaximumChunks() throws IOException {
		Reader fr = new FakeReader(new char[] { 'a', 'b' }, new char[] { 'c',
				'd' });
