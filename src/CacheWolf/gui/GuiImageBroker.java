...
public final class GuiImageBroker {
	...
	public static void customizedSymbols() {
		FileBugfix dir = new FileBugfix(FileBase.getProgramDirectory()
				+ "/symbols");
		if (dir.isDirectory()) {
			int id;
			String name = "";
