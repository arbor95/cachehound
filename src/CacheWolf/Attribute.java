...
public class Attribute {
	...
	public Attribute(String attributeName) {
		attNo = attName2int(attributeName);
	}
	...
	/**
	 * Get the image for a given attribute number. We use lazy initialisation
	 * here, i.e. the images are only loaded when they are requested.
	 * 
	 * @param attNo
	...
	public mImage getImage() {
		...
		if (attributeImages[attNo] == null) {
			attributeImages[attNo] = new mImage(IMAGEDIR
					+ attributeNames[attNo]);
		}
