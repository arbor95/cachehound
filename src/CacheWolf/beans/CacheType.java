...
/**
 * Handles all aspects of converting cache type information from and to the
...
public final class CacheType {
	...
	/**
	 * translate cache type to a short version for compact exporters or "smart"
	 * cache names.
	 * 
	 * @param type
	 ...
	 *             if <code>type</code> can not be mapped
	 */
	public static String getExportShortId(byte type)
			throws IllegalArgumentException {
		switch (type) {
		case CW_TYPE_CUSTOM:
			return "C";
	...
	public static final String[] guiTypeStrings() {
		String ret[] = new String[] { CW_GUISTR_CUSTOM, CW_GUISTR_TRADI,
				CW_GUISTR_MULTI, CW_GUISTR_VIRTUAL, CW_GUISTR_LETTERBOX,
				CW_GUISTR_EVENT, CW_GUISTR_MEGAEVENT, CW_GUISTR_WEBCAM,
				CW_GUISTR_UNKNOWN, CW_GUISTR_LOCATIONLESS, CW_GUISTR_CITO,
				CW_GUISTR_EARTH, CW_GUISTR_WHEREIGO, CW_GUISTR_PARKING,
				CW_GUISTR_STAGE, CW_GUISTR_QUESTION, CW_GUISTR_FINAL,
				CW_GUISTR_TRAILHEAD, CW_GUISTR_REFERENCE };
		return ret;
	}
	 ...
	 */
	// TODO: move to a class "closer" to the gui?
	public static final byte guiSelect2Cw(int selection)
			throws IllegalArgumentException {
		...
		default:
			throw new IllegalArgumentException("unmatched argument "
					+ selection + " in CacheSize guiSelect2Cw()");
		}
	}

	/**
	 * translate cache type to position of index to highlight in GUI cache type
	 * drop down list
	 * 
	 * @param id
	 ...
	 */
	// TODO: move to a class "closer" to the gui?
	public static final int cw2GuiSelect(byte id)
			throws IllegalArgumentException {
		switch (id) {
		case CW_TYPE_CUSTOM:
			return 0;
		...
		default:
			throw new IllegalArgumentException("unmatched argument " + id
					+ " in CacheSize cw2GuiSelect()");
		}
	}

	/**
	 * convert the strings found in import of GPX from GC, OC or TC to internal
	 * cache type
	 * 
	 * @param gpxType
	 ...
	 */
	public static final byte gpxType2CwType(String gpxType)
			throws IllegalArgumentException {
		if (gpxType.equals(GC_GPX_TRADITIONAL) || gpxType.equals("Traditional")
				|| gpxType.equals("Classic"))
			return CW_TYPE_TRADITIONAL;
		if (gpxType.equals(GC_GPX_MULTI) || gpxType.equals("Multi")
				|| gpxType.equals("Offset"))
			return CW_TYPE_MULTI;
		if (gpxType.equals(GC_GPX_VIRTUAL) || gpxType.equals("Virtual"))
			return CW_TYPE_VIRTUAL;
		if (gpxType.equals(GC_GPX_LETTERBOX))
			return CW_TYPE_LETTERBOX;
		if (gpxType.equals(GC_GPX_EVENT) || gpxType.equals("Event"))
			return CW_TYPE_EVENT;
		if (gpxType.equals(GC_GPX_UNKNOWN) || gpxType.equals("Other")
				|| gpxType.equals("Quiz"))
			return CW_TYPE_UNKNOWN;
		if (gpxType.equals(GC_GPX_WEBCAM) || gpxType.equals("Webcam"))
			return CW_TYPE_WEBCAM;
		if (gpxType.equals(GC_GPX_LOCATIONLESS))
			return CW_TYPE_LOCATIONLESS;
		if (gpxType.equals(GC_GPX_CITO))
			return CW_TYPE_CITO;
		if (gpxType.equals(GC_GPX_EARTH) || gpxType.equals("Earth"))
			return CW_TYPE_EARTH;
		if (gpxType.equals(GC_GPX_MEGA_EVENT))
			return CW_TYPE_MEGA_EVENT;
		if (gpxType.equals(GC_GPX_WHEREIGO))
			return CW_TYPE_WHEREIGO;
		if (gpxType.equals(GC_GPX_PARKING))
			return CW_TYPE_PARKING;
		if (gpxType.equals(GC_GPX_STAGE))
			return CW_TYPE_STAGE;
		if (gpxType.equals(GC_GPX_QUESTION))
			return CW_TYPE_QUESTION;
		if (gpxType.equals(GC_GPX_FINAL)
				|| gpxType.equals("Waypoint|Final Location"))
			return CW_TYPE_FINAL;
		if (gpxType.equals(GC_GPX_TRAILHEAD))
			return CW_TYPE_TRAILHEAD;
		if (gpxType.equals(GC_GPX_REFERENCE))
			return CW_TYPE_REFERENCE;
		if (gpxType.equals(GC_GPX_MAZE))
			return CW_TYPE_MAZE;
		if (gpxType.equals(GC_GPX_APE))
			return CW_TYPE_APE;
		return CW_TYPE_CUSTOM;
	}

	/**
	 * convert the cache type information from an OC XML import to internal
	 * cache type
	 * 
	 * @param ocType
	 ...
	 */
	public static final byte ocType2CwType(String ocType)
			throws IllegalArgumentException {
		if (ocType.equals("1"))
			return CW_TYPE_UNKNOWN;
		if (ocType.equals("2"))
		...
		if (ocType.equals("9"))
			return CW_TYPE_UNKNOWN;
		if (ocType.equals("10"))
			return CW_TYPE_TRADITIONAL; // drive in
		throw new IllegalArgumentException("unmatched argument " + ocType
				+ " in CacheSize ocType2CwType()");
	}

	/**
	 * convert type information discovered by GC spider to internal type
	 * information
	 * 
	 * @param gcType
	 ...
	 */
	public static final byte gcSpider2CwType(String gcType)
			throws IllegalArgumentException {
		if (gcType.equals("2")) {
			return CW_TYPE_TRADITIONAL;
		}
		...
		if (gcType.equals("137")) {
			return CW_TYPE_EARTH;
		}
		if (gcType.equals("453")) {
			return CW_TYPE_MEGA_EVENT;
		}
		if (gcType.equals("1304")) {
			return CW_TYPE_MAZE;
		}
		if (gcType.equals("1858")) {
			return CW_TYPE_WHEREIGO;
		}
		throw new IllegalArgumentException("unmatched argument " + gcType
				+ " in CacheSize gcSpider2CwType()");
	}
	 ...
	 *             if <code>id</code> can not be matched
	 */
	public static final String typeImageForId(byte id)
			throws IllegalArgumentException {
		switch (id) {
		case CW_TYPE_CUSTOM:
			return "CW_GUIIMG_CUSTOM";
		case CW_TYPE_TRADITIONAL:
			return CW_GUIIMG_TRADITIONAL;
		case CW_TYPE_MULTI:
			return CW_GUIIMG_MULTI;
		case CW_TYPE_VIRTUAL:
			return CW_GUIIMG_VIRTUAL;
		case CW_TYPE_LETTERBOX:
			return CW_GUIIMG_LETTERBOX;
		case CW_TYPE_EVENT:
			return CW_GUIIMG_EVENT;
		case CW_TYPE_WEBCAM:
			return CW_GUIIMG_WEBCAM;
		case CW_TYPE_UNKNOWN:
			return CW_GUIIMG_UNKNOWN;
		case CW_TYPE_LOCATIONLESS:
			return CW_GUIIMG_LOCATIONLESS;
		case CW_TYPE_CITO:
			return CW_GUIIMG_CITO;
		case CW_TYPE_EARTH:
			return CW_GUIIMG_EARTH;
		case CW_TYPE_MEGA_EVENT:
			return CW_GUIIMG_MEGA_EVENT;
		case CW_TYPE_WHEREIGO:
			return CW_GUIIMG_WHEREIGO;
		case CW_TYPE_PARKING:
			return CW_GUIIMG_PARKING;
		case CW_TYPE_STAGE:
			return CW_GUIIMG_STAGE;
		case CW_TYPE_QUESTION:
			return CW_GUIIMG_QUESTION;
		case CW_TYPE_FINAL:
			return CW_GUIIMG_FINAL;
		case CW_TYPE_TRAILHEAD:
			return CW_GUIIMG_TRAILHEAD;
		case CW_TYPE_REFERENCE:
			return CW_GUIIMG_REFERENCE;
		case CW_TYPE_APE:
			return CW_GUIIMG_APE;
		case CW_TYPE_MAZE:
			return CW_GUIIMG_MAZE;
		default:
			throw new IllegalArgumentException("unmatched argument " + id
					+ " in CacheSize typeImageForId()");
		}
	}
	...
	public static final String id2GpxString(byte id)
		...
		switch (id) {
		case CW_TYPE_TRADITIONAL:
			return "Geocache|".concat(GC_GPX_TRADITIONAL);
		case CW_TYPE_MULTI:
			return "Geocache|".concat(GC_GPX_MULTI);
		case CW_TYPE_VIRTUAL:
			return "Geocache|".concat(GC_GPX_VIRTUAL);
		case CW_TYPE_LETTERBOX:
			return "Geocache|".concat(GC_GPX_LETTERBOX);
		case CW_TYPE_EVENT:
			return "Geocache|".concat(GC_GPX_EVENT);
		case CW_TYPE_UNKNOWN:
			return "Geocache|".concat(GC_GPX_UNKNOWN);
		case CW_TYPE_WEBCAM:
			return "Geocache|".concat(GC_GPX_WEBCAM);
		case CW_TYPE_LOCATIONLESS:
			return "Geocache|".concat(GC_GPX_LOCATIONLESS);
		case CW_TYPE_CITO:
			return "Geocache|".concat(GC_GPX_CITO);
		case CW_TYPE_EARTH:
			return "Geocache|".concat(GC_GPX_EARTH);
		case CW_TYPE_MEGA_EVENT:
			return "Geocache|".concat(GC_GPX_MEGA_EVENT);
		case CW_TYPE_WHEREIGO:
			return "Geocache|".concat(GC_GPX_WHEREIGO);
		case CW_TYPE_PARKING:
		...
		case CW_TYPE_MAZE:
			return "Geocache|".concat(GC_GPX_MAZE);
		case CW_TYPE_APE:
			return "Geocache|".concat(GC_GPX_APE);
		case CW_TYPE_CUSTOM:
	 ...
	 * @throws IllegalArgumentException
	 *             if <code>id</code> is not a valid cache type
	 */
	public static final String cw2ExportString(byte id)
			throws IllegalArgumentException {
		String ret;
		try {
			ret = id2GpxString(id);
	 ...
	 * @return true if <code>type</code> matches on of the CacheWolf types,
	 *         false otherwise
	 */
