...
public enum CacheSize {
	...
	NOT_CHOSEN("Not chosen" , "sizeNonPhysical.png", Integer.MIN_VALUE, Integer.MIN_VALUE, 'n', (byte)0, (byte) (0x01 << 5)),
	NONE("None" , "sizeNonPhysical.png", 7, Integer.MIN_VALUE, 'n', (byte)7, (byte)(0x01 << 5)),
	VIRTUAL("Virtual" , "sizeNonPhysical.png", Integer.MIN_VALUE, Integer.MIN_VALUE, 'n', (byte)8, (byte)(0x01 << 5)),
	OTHER("Other" , "unset", 1, Integer.MIN_VALUE, 'n', (byte)1, (byte)(0x01 << 5)),
	...
	VERY_LARGE("Very large" , "sizeVLarge.png", 6, Integer.MIN_VALUE, 'v', (byte)6, (byte)(0x01 << 4));
	...
	private CacheSize(String gcSizeString, String cwSizeGuiFileName, int ocSizeId, int tcSizeId, char shortId, byte oldCwId, byte filterPattern) {
	...
	public static CacheSize fromTcGpxString(String tcString) {
		...
		throw (new IllegalArgumentException("unmatched argument "
				+ tcString + " in CacheSize fromTcGpxString()"));
	}
	...
	public static CacheSize fromNormalStringRepresentation(String gcString) {
		...
		throw (new IllegalArgumentException("unmatched argument "
				+ gcString + " in CacheSize fromGcGpxString()"));
	}
	...
	public static CacheSize fromOcString(String ocString) {
		...
		throw (new IllegalArgumentException("unmatched argument "
				+ ocString + " in CacheSize fromOcString()"));
